        ...
        <div class="row">
            ...
            <div class="p-l-25 p-r-30 p-lr-0-lg">
              <div class="wrap-slick3 flex-sb flex-w">
                ...
                <div class="slick3 gallery-lb">
                  <div class="item-slick3" data-thumb="../assets/images/product-08.jpg">
                    <div class="wrap-pic-w pos-relative">
                      <img src="../assets/images/product-08.jpg" alt="IMG-PRODUCT" />

                      <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../assets/images/product-08.jpg">
          ...
          <div class="col-md-6 col-lg-5 p-b-30">
            ...
            <?php
              ...
              ?>
              <input type="hidden" name="prod_id" value="m4">
              <input type="hidden" name="prod_name" value="Men Style 4">
              <h4 class="mtext-105 cl2 js-name-detail p-b-14">Men Style 4</h4>
        ...
        <div class="slick2">
          ...
          <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
            ...
            <div class="block2">
              ...
              <div class="block2-txt flex-w flex-t p-t-14">
                <div class="block2-txt-child1 flex-col-l">
                  <a href="men-style-3.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                    Men Style 3
                  </a>
